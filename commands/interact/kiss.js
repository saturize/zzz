...
exports.run = async (client, message, args) => {
    ...
    if (!userToKiss) {
        return message.reply('Veuillez mentionner quelqu\'un à qui faire un bisou.');
    }
        ...
        if (response.data && response.data.results && response.data.results.length > 0) {
            ...
            if (gifUrl) {
                const embed = new EmbedBuilder()
                    ...
                    .setDescription(`${message.author} a fait un bisou à ${userToKiss}!`)
                    .setImage(gifUrl);
...
exports.name = "kiss";
exports.description = "Fais un bisou à un utilisateur.";